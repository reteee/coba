...
APP_ID = APP_ID
API_HASH = API_HASH
COMMAND_HAND_LER = COMMAND_HANDLER
...
OFFICIAL_UPSTREAM_REPO = OFFICIAL_UPSTREAM_REPO
...
TG_MAX_SELECT_LEN = TG_MAX_SELECT_LEN
...
PM_PERMIT = PM_PERMIT
UB_VERSION = "v2.3.4"
REMBG_API_KEY = REMBG_API_KEY
MEGANZ_EMAIL = MEGANZ_EMAIL
MEGANZ_PASSWORD = MEGANZ_PASSWORD
